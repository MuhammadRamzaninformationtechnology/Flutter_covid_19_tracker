/// updated : 1683551858651
/// cases : 687840686
/// todayCases : 33372
/// deaths : 6871233
/// todayDeaths : 153
/// recovered : 660283113
/// todayRecovered : 17109
/// active : 20686340
/// critical : 39116
/// casesPerOneMillion : 88244
/// deathsPerOneMillion : 881.5
/// tests : 6985081347
/// testsPerOneMillion : 879186.71
/// population : 7944935131
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2603.71
/// recoveredPerOneMillion : 83107.43
...
class WorldStatesModels {
  ...
  WorldStatesModels.fromJson(dynamic json) {
...
WorldStatesModels copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => WorldStatesModels(  updated: updated ?? _updated,
  cases: cases ?? _cases,
